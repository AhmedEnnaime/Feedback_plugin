...
?>
        ...
        <div class="feedback">
            ...
            <form id="feedback" action="">
                ...
                <input type="text" name="subject" id="subject" min="0" max="5" required placeholder="Enter the subject you want to talk about">
                <br>
                <label for="details">Details:</label>
                <textarea name="details" id="details" rows="5" required placeholder="Enter details"></textarea>
                <br>
    ...
    { ?>
        <script>
            ...
            jQuery(feedback).submit(function(event) {
                ...
                jQuery('#firstname, #lastname, #subject, #details').val('');
            });
        </script>
<?php }
